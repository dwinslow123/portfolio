    ...
    return (
        <div className="container mx-auto p-4 max-w-3xl">
            ...
            <div className="w-full flex flex-col items-center">
                <Image className="mb-4 rounded-lg flex items-center justify-center border border-gray-300" src={project.imageurl} alt={project.title} width={600} height={400} />
                <div className="flex flex-col gap-4 md:flex-row w-full items-center">
                    {project.githuburl ? (<div className="mt-4 flex flex-1 flex-col sm:flex-row w-full items-center border-gray-300 gap-4">
                        ...
                        <div className="border-solid border border-gray-300 w-full flex-1 hidden md:block"></div>
                        ...
                        <div className="mt-4 w-full flex justify-center items-center">
                            <div className="border-solid border border-gray-300 w-full flex-1 hidden md:block mr-4 h-0"></div>
                            <button className="rounded-lg bg-gray-900 px-4 py-2 hover:bg-blue-700 transition-all duration-200 ease-in-out w-45">
                                <a className="text-gray-100" href={project.demourl}>Visit Project &#x2197;</a>
                            </button>
                            <div className="border-solid border border-gray-300 w-full flex-1 hidden md:block ml-4 h-0"></div>
                        </div>
                    )}
                </div>
            </div>
