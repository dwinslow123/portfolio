...
const Maintenance = () => {
    ...
    <div className="row-start-2 flex flex-col gap-8 sm:gap-16 w-full max-w-3xl mx-auto p-8 justify-center items-center">
        ...
        <p className="text-center mt-2">Sorry for the inconvenience. Please check back later!</p>
        <Image src={constants.MAINTENANCE_URL} alt="Maintenance" width={550} height={400}/>
    </div>
    )
};
